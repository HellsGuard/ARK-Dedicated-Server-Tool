...
namespace ARK_Server_Manager.Lib
{
    ...
    public static class GameData
    {
        ...
        private static readonly EngramEntry[] engrams = new[]
        {
            ...
            //new EngramEntry { EngramClassName="EngramEntry_TekBoots_C",                      EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekGloves_C",                     EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekHelmet_C",                     EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekPants_C",                      EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekReplicator_C",                 EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekRexSaddle_C",                  EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekRifle_C",                      EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekShirt_C",                      EngramLevelRequirement=0, EngramPointsCost=0 },
            //new EngramEntry { EngramClassName="EngramEntry_TekTransmitter_C",                EngramLevelRequirement=0, EngramPointsCost=0 },
